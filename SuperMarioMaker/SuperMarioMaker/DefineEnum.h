...
// SOUND
enum SOUDN_BGM : unsigned int { LOGIN_BGM, TITLE_BGM, MAKER_BGM, PLAY_BGM, LOBBY_BGM, ROOM_BGM, UP_DOWNLOAD_BGM }; // 7

enum SOUND_EFFRCT : unsigned int { SOUND_INIT, SOUND_LOGIN_BUTTON, SOUND_BUTTON, SOUND_JUMP, SOUND_POWER_DOWN, SOUND_POWER_UP, SOUND_DIE, SOUND_COIN, SOUND_BREAK,
 SOUND_BUMP, SOUND_GOAL }; // 11